...
# Import Dataset
df_orders_dataset = pd.read_csv('https://raw.githubusercontent.com/YunicoArdianPradana/Proyek_Analisis_Data/master/datasets/olist_orders_dataset.csv')
df_customer = pd.read_csv('https://raw.githubusercontent.com/YunicoArdianPradana/Proyek_Analisis_Data/master/datasets/olist_customers_dataset.csv')
df_order_payments = pd.read_csv('https://raw.githubusercontent.com/YunicoArdianPradana/Proyek_Analisis_Data/master/datasets/olist_order_payments_dataset.csv')
df_products_dataset = pd.read_csv('https://raw.githubusercontent.com/YunicoArdianPradana/Proyek_Analisis_Data/master/datasets/olist_products_dataset.csv')
df_product_name = pd.read_csv('https://raw.githubusercontent.com/YunicoArdianPradana/Proyek_Analisis_Data/master/datasets/product_category_name_translation.csv')
df_order_items = pd.read_csv('https://raw.githubusercontent.com/YunicoArdianPradana/Proyek_Analisis_Data/master/datasets/olist_order_items_dataset.csv')
